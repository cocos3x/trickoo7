using UnityEngine;
private sealed class MaxHelper.<WaitToShowRewarded>d__6 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    // Methods
    public MaxHelper.<WaitToShowRewarded>d__6(int <>1__state)
    {
