using UnityEngine;
private sealed class MaxHelper.<WaitToShowInterstitial>d__12 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    // Methods
    public MaxHelper.<WaitToShowInterstitial>d__12(int <>1__state)
    {
