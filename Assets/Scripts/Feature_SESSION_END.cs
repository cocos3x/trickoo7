using UnityEngine;
public struct Feature_SESSION_END
{
    // Fields
    private Feature_SESSION_END.EVENT_NAME <EventName>k__BackingField;
    private string <Level>k__BackingField;
    private string <FailCount>k__BackingField;
    
    // Properties
    public Feature_SESSION_END.EVENT_NAME EventName { get; set; }
    public string Level { get; set; }
    public string FailCount { get; set; }
    
    // Methods
    public Feature_SESSION_END.EVENT_NAME get_EventName()
    {
        return (EVENT_NAME)new Feature_SESSION_END();
    }
    public void set_EventName(Feature_SESSION_END.EVENT_NAME value)
    {
        this = value;
    }
