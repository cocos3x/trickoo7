using UnityEngine;
private sealed class IronHelper.<WaitToShowInterstitial>d__11 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    // Methods
    public IronHelper.<WaitToShowInterstitial>d__11(int <>1__state)
    {
    ...
    private bool MoveNext()
    {
        ...
        this.<>1__state = 0;
        label_3:
        if(((public static System.Boolean AdsBase<IronHelper>::get_InterIsReady()) & 1) != 0)
        {
            goto label_6;
        }
