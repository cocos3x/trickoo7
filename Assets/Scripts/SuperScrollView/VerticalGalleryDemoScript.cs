...
namespace SuperScrollView
{
    public class VerticalGalleryDemoScript : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            this.mScrollToButton.m_OnClick.AddListener(call:  new UnityEngine.Events.UnityAction(object:  this, method:  System.Void SuperScrollView.VerticalGalleryDemoScript::OnJumpBtnClicked()));
            this.mAddItemButton.m_OnClick.AddListener(call:  new UnityEngine.Events.UnityAction(object:  this, method:  System.Void SuperScrollView.VerticalGalleryDemoScript::OnAddItemBtnClicked()));
            this.mSetCountButton.m_OnClick.AddListener(call:  new UnityEngine.Events.UnityAction(object:  this, method:  System.Void SuperScrollView.VerticalGalleryDemoScript::OnSetItemCountBtnClicked()));
            this.mBackButton = UnityEngine.GameObject.Find(name:  "ButtonPanel/BackButton").GetComponent<UnityEngine.UI.Button>();
            val_20.m_OnClick.AddListener(call:  new UnityEngine.Events.UnityAction(object:  this, method:  System.Void SuperScrollView.VerticalGalleryDemoScript::OnBackBtnClicked()));
        }
        ...
        private SuperScrollView.LoopListViewItem2 OnGetItemByIndex(SuperScrollView.LoopListView2 listView, int index)
        {
            ...
            val_8 = val_5;
            SuperScrollView.ListItem2 val_6 = val_5.GetComponent<SuperScrollView.ListItem2>();
        ...
        private void LateUpdate()
        {
            ...
            do
            {
                SuperScrollView.ListItem2 val_3 = this.mLoopListView.GetShownItemByIndex(index:  0).GetComponent<SuperScrollView.ListItem2>();
