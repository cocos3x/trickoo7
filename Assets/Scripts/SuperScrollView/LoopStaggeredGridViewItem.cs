...
namespace SuperScrollView
{
    public class LoopStaggeredGridViewItem : MonoBehaviour
    {
        ...
        private SuperScrollView.LoopStaggeredGridView mParentListView;
        ...
        public SuperScrollView.LoopStaggeredGridView ParentListView { get; set; }
        ...
        {
            return (float)this.mExtraPadding;
        }
        ...
        {
            return (int)this.mItemIndexInGroup;
        }
        ...
        public SuperScrollView.LoopStaggeredGridView get_ParentListView()
        {
            return (SuperScrollView.LoopStaggeredGridView)this.mParentListView;
        }
        public void set_ParentListView(SuperScrollView.LoopStaggeredGridView value)
        {
