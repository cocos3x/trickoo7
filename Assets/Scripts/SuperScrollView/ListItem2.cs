    ...
    public class ListItem2 : MonoBehaviour
    {
        ...
        public void Init()
        {
                ...
                if(val_5 >= this.mStarArray.Length)
            {
                ...
                val_3.mClickedHandler = new System.Action<UnityEngine.GameObject>(object:  new ListItem2.<>c__DisplayClass10_0(), method:  System.Void ListItem2.<>c__DisplayClass10_0::<Init>b__0(UnityEngine.GameObject obj));
                val_5 = val_5 + 1;
            }
