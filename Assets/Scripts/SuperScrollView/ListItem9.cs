...
namespace SuperScrollView
{
    public class ListItem9 : MonoBehaviour
    {
        ...
        public void Init()
        {
            ...
            val_2.mClickedHandler = new System.Action<UnityEngine.GameObject>(object:  this, method:  System.Void SuperScrollView.ListItem9::OnStarClicked(UnityEngine.GameObject obj));
            this.mToggle.onValueChanged.AddListener(call:  new UnityEngine.Events.UnityAction<System.Boolean>(object:  this, method:  System.Void SuperScrollView.ListItem9::OnToggleValueChanged(bool check)));
        }
