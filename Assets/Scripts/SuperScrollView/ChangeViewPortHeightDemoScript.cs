...
namespace SuperScrollView
{
    public class ChangeViewPortHeightDemoScript : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            this.mScrollToButton.m_OnClick.AddListener(call:  new UnityEngine.Events.UnityAction(object:  this, method:  System.Void SuperScrollView.ChangeViewPortHeightDemoScript::OnJumpBtnClicked()));
            this.mBackButton = UnityEngine.GameObject.Find(name:  "ButtonPanel/BackButton").GetComponent<UnityEngine.UI.Button>();
            val_10.m_OnClick.AddListener(call:  new UnityEngine.Events.UnityAction(object:  this, method:  System.Void SuperScrollView.ChangeViewPortHeightDemoScript::OnBackBtnClicked()));
            ...
            val_13.m_OnClick.AddListener(call:  new UnityEngine.Events.UnityAction(object:  this, method:  System.Void SuperScrollView.ChangeViewPortHeightDemoScript::OnAppendMsgBtnClicked()));
            this.mDragChangSizeScript.mOnDragEndAction = new System.Action(object:  this, method:  System.Void SuperScrollView.ChangeViewPortHeightDemoScript::OnViewPortHeightChanged());
        }
        private void OnViewPortHeightChanged()
        {
            if(this.mLoopListView != null)
            {
                    this.mLoopListView.ResetListView(resetPos:  false);
                return;
            }
        ...
        public ChangeViewPortHeightDemoScript()
        {
